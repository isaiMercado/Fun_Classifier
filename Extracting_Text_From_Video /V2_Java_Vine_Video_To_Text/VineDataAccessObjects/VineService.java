...
import Types.VineComment;
import Types.VineEntity;
import Types.VineNotificationsResponse;
import Types.VinePost;
import Types.VinePostsResponse;
import Types.VineTagsResponse;
import Types.VineUser;
...
public class VineService {
	 ...
	 */
	public boolean comment(VinePost post, String comment, List<VineEntity> entities) throws Exception {
		if (post != null) {
	...
	public boolean comment(long postId, String comment, List<VineEntity> entities) throws Exception {
		if (postId > 0) {
